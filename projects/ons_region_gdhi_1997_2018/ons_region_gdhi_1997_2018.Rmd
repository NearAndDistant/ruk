...
mutate(region_name = if_else(region_name == "Yorkshire And The Humber", "Yorkshire", region_name)) %>%
  ...
  theme(plot.background = element_rect(fill = "white" , color = "white"),
        ...
        plot.margin = margin(2,1,14,1, unit = "cm"))
...
ggdraw(plot_region_gdhi_roc) +
  ...
  draw_text("North West" , size = 9 , hjust = 0 , x = 0.923 , y = 0.665) +
  draw_text("Scotland" ,   size = 9 , hjust = 0 , x = 0.923 , y = 0.705) +
  draw_text("Data: ONS | Graphic: @NearAndDistant" ,   size = 12 , hjust = 0 , x = 0.36 , y = 0.86) +
  theme(plot.background = element_rect(fill = "white" , color = "white"))
