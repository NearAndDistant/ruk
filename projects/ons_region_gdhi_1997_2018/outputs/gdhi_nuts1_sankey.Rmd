...
sankeyNetwork(Links = nd3_gdhi$links, Nodes = nd3_gdhi$nodes , 
              ...
              units = "(£m)", fontSize = 15, fontFamily = "Arial" ,
...
htmlwidgets::onRender(gdhi_nuts1_sankey,
  'function(el, x) {
    ...
    d3.select("body").style("background-color", "#373737"); 
  }'
)
...
# save it as html
saveNetwork(gdhi_nuts1_sankey, here::here("projects/ons_region_gdhi_1997_2018/outputs/gdhi_nuts1_sankey_blackviridis.html"))

library(webshot2)
# you convert it as png
webshot(here::here("projects/ons_region_gdhi_1997_2018/outputs/gdhi_nuts1_sankey_blackviridis.html"),
        here::here("projects/ons_region_gdhi_1997_2018/outputs/gdhi_nuts1_sankey_blackviridis.png"),
