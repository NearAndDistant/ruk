...
# read xls
uk_dis_income <- readxl::read_xls(temp_ons_97_to_18, sheet = "Table 1", skip = 1) %>% rename(`2018` = `20182`)
...
dir.create(here::here("data_scripts/ons_gross_income_1997_to_2018"))

write_csv(uk_dis_income , here::here("data_scripts/ons_gross_income_1997_to_2018/ons_gross_income_1997_to_2018.csv"))
